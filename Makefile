...
pdf: $(INPUT)
	...
	./embed_xml.sh
	PATH=/mingw32/bin:$(PATH) gs -dPDFA=3 -dBATCH -dNOPAUSE -sColorConversionStrategy=RGB -sProcessColorModel=DeviceRGB -dPDFACompatibilityPolicy=3 -I. -sDEVICE=pdfwrite -sOutputFile=$(OUTPUT) PDFA_def.ps embed.ps  zugferd_generated.pdf 
